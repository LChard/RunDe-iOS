...
//        self.isScreenLandScape = NO;
        ...
        [self layoutIfNeeded];//
        CGRect rect = view.frame;
        [self.smallVideoView setFrame:CGRectMake(rect.size.width -CCGetRealFromPt(220), SCREEN_WIDTH *0.5625+CCGetRealFromPt(82)+(IS_IPHONE_X? 44:20), CCGetRealFromPt(200), CCGetRealFromPt(150))];
        [self layouUI:NO];
...
//    [self.changeButton setBackgroundImage:nil forState:UIControlStateNormal];
