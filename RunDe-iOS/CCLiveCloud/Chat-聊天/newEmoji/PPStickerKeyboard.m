...
- (UIView *)bottomBGView
{
    if (!_bottomBGView) {
        ...
        _bottomBGView.backgroundColor = [UIColor colorWithLight:[UIColor colorWithHexString:@"#F4F4F4" alpha:1.0f] Dark:[UIColor colorWithRed:31/255.0 green:31/255.0 blue:31/255.0 alpha:1.0]];
    }
...
- (void)reloadScrollableSegment
{
    ...
    for (NSUInteger index = 0, max = self.stickers.count; index < max; index++) {
        ...
        button.backgroundColor = (_currentStickerIndex == index ? [UIColor colorWithLight:[UIColor pp_colorWithRGBString:@"#EDEDED"] Dark:[UIColor colorWithRed:29/255.0 green:29/255.0 blue:29/255.0 alpha:1.0]] : [UIColor clearColor]);
